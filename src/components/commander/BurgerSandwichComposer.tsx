        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 p-4 lg:p-6 border-t border-gray-200 bg-gray-50">
            <Button
              ...
              className="min-h-[48px] lg:min-h-0 px-4 lg:px-4 py-3 lg:py-2 text-base font-medium"
            >
            ...
            {/* Quantité : uniquement sur desktop (panier pour modifier sur mobile) */}
            ...
            {currentStep === steps.length - 1 ? (
              <Button onClick={handleAddToCart} disabled={!canProceed()} className="min-h-[48px] lg:min-h-0 px-4 lg:px-4 py-3 lg:py-2 text-base font-medium">
                <span className="hidden lg:inline">Ajouter au panier</span>
                <span className="lg:hidden">+ Panier</span>
              </Button>
            ) : (
              <Button onClick={handleNext} disabled={!canProceed()} className="min-h-[48px] lg:min-h-0 px-4 lg:px-4 py-3 lg:py-2 text-base font-medium">
